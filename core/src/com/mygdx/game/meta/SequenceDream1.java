...
public class SequenceDream1 extends Sequence
{
	enum EState 
	{
		Start_Sleep,
	...
	public String getTopString()
	{
		switch (m_eState)
		{
			...
			case Start_Sleep_No: 	return "Cannot sleep. Stay Awake. Then eyelids drop. Sleep comes.";

			case s1: 				return "Hazy dream. Memory. Wife pregnant. Screaming.";
			case s2: 				return "Will get doctor. Wife cannot speak. But tries.";
			case s3: 				return "Lean in. Hold hand.";
			case s4: 				return "Tell her need get help. Leave her.";
			case s5: 				return "\"Should not.\" she says.";
			case s6: 				return "\"Should not.\"";
