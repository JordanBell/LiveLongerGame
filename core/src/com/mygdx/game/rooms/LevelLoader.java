...
public class LevelLoader
{
	...
	public static List<Level> m_lpLevels = new ArrayList<Level>();
	
	public static void parseFile(String i_sFilePath) throws IOException
	{
		// Add a new level
	...
	public static Level getLevelByID(String i_sID)
	{
